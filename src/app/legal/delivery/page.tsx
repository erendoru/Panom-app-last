        ...
        <PublicLayout>
            <div className="container mx-auto px-4 py-16 max-w-4xl">
                ...
                <div className="prose prose prose-neutral prose-lg max-w-none space-y-8">
                    <section>
                        <h2 className="text-2xl font-bold text-neutral-900 mb-4">1. Hizmet Türü</h2>
                    ...
                    <section>
                        <h2 className="text-2xl font-bold text-neutral-900 mb-4">2. Yayın Süreci</h2>
                    ...
                    <section>
                        <h2 className="text-2xl font-bold text-neutral-900 mb-4">3. Görsel Teslim Koşulları</h2>
                        <div className="bg-slate-800 p-6 rounded-lg">
                            <h3 className="text-lg font-bold text-neutral-900 mb-4">Teknik Gereksinimler:</h3>
                    ...
                    <section>
                        <h2 className="text-2xl font-bold text-neutral-900 mb-4">4. Görsel Teslim Süreleri</h2>
                        <ul className="list-disc list-inside text-neutral-600 space-y-2">
                    ...
                    <section>
                        <h2 className="text-2xl font-bold text-neutral-900 mb-4">5. Tasarım Hizmeti</h2>
                    ...
                    <section>
                        <h2 className="text-2xl font-bold text-neutral-900 mb-4">6. Yayın Doğrulama</h2>
                        <p className="text-neutral-600">
                    ...
                    <section>
                        <h2 className="text-2xl font-bold text-neutral-900 mb-4">7. Yayın Garantisi</h2>
                        <p className="text-neutral-600">
                    ...
                    <section>
                        ...
                        <p className="text-neutral-600 mb-4">Teslimat ve yayın konularında sorularınız için:</p>
                        <div className="bg-slate-800 p-6 rounded-lg">
