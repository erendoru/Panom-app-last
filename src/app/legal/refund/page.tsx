        ...
        <PublicLayout>
            <div className="container mx-auto px-4 py-16 max-w-4xl">
                ...
                <div className="prose prose prose-neutral prose-lg max-w-none space-y-8">
                    <section>
                        <h2 className="text-2xl font-bold text-neutral-900 mb-4">1. Genel İade Koşulları</h2>
                    ...
                    <section>
                        <h2 className="text-2xl font-bold text-neutral-900 mb-4">2. İptal ve İade Süreleri</h2>
                        <div className="bg-slate-800 p-6 rounded-lg space-y-4">
                            <div className="border-b border-slate-700 pb-4">
                                <h3 className="text-lg font-bold text-green-400">Yayın Başlangıcından 14+ Gün Önce</h3>
                                <p className="text-neutral-600 mt-2">%100 iade (tam iade)</p>
                            </div>
                            <div className="border-b border-slate-700 pb-4">
                                <h3 className="text-lg font-bold text-yellow-400">Yayın Başlangıcından 7-14 Gün Önce</h3>
                                <p className="text-neutral-600 mt-2">%50 iade</p>
                            </div>
                            <div className="border-b border-slate-700 pb-4">
                                <h3 className="text-lg font-bold text-orange-400">Yayın Başlangıcından 3-7 Gün Önce</h3>
                                <p className="text-neutral-600 mt-2">%25 iade</p>
                            </div>
                            <div>
                                <h3 className="text-lg font-bold text-red-400">Yayın Başlangıcından 3 Günden Az Önce</h3>
                                <p className="text-neutral-600 mt-2">İade yapılmaz</p>
                            </div>
                        </div>
                    </section>

                    <section>
                        <h2 className="text-2xl font-bold text-neutral-900 mb-4">3. Tam İade Yapılan Durumlar</h2>
                    ...
                    <section>
                        <h2 className="text-2xl font-bold text-neutral-900 mb-4">4. İade Yapılmayan Durumlar</h2>
                        <ul className="list-disc list-inside text-neutral-600 space-y-2">
                    ...
                    <section>
                        <h2 className="text-2xl font-bold text-neutral-900 mb-4">5. Tasarım Hizmeti İadeleri</h2>
                        <p className="text-neutral-600">
                    ...
                    <section>
                        <h2 className="text-2xl font-bold text-neutral-900 mb-4">6. İade Süreci</h2>
                    ...
                    <section>
                        <h2 className="text-2xl font-bold text-neutral-900 mb-4">7. İade Yöntemi</h2>
                        <p className="text-neutral-600">
                    ...
                    <section>
                        ...
                        <p className="text-neutral-600 mb-4">İade talepleriniz için:</p>
                        <div className="bg-slate-800 p-6 rounded-lg">
                            <p className="text-neutral-900"><strong>E-posta:</strong> destek@panobu.com</p>
                            <p className="text-neutral-900 mt-2"><strong>Konu:</strong> İade Talebi - [Sipariş Numaranız]</p>
                        </div>
                    </section>
                </div>
            </div>
