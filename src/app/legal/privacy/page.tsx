        ...
        <PublicLayout>
            <div className="container mx-auto px-4 py-16 max-w-4xl">
                ...
                <div className="prose prose prose-neutral prose-lg max-w-none space-y-8">
                    ...
                    <section>
                        <h2 className="text-2xl font-bold text-neutral-900 mb-4">2. Toplanan Veriler</h2>
                        <p className="text-neutral-600 mb-4">Hizmetlerimizi sunabilmek için aşağıdaki verileri topluyoruz:</p>
                    ...
                    <section>
                        <h2 className="text-2xl font-bold text-neutral-900 mb-4">3. Verilerin Kullanımı</h2>
                        <p className="text-neutral-600 mb-4">Toplanan veriler aşağıdaki amaçlarla kullanılmaktadır:</p>
                        <ul className="list-disc list-inside text-neutral-600 space-y-2">
                    ...
                    <section>
                        <h2 className="text-2xl font-bold text-neutral-900 mb-4">4. Verilerin Paylaşımı</h2>
                    ...
                    <section>
                        <h2 className="text-2xl font-bold text-neutral-900 mb-4">5. Çerezler (Cookies)</h2>
                        <p className="text-neutral-600">
                    ...
                    <section>
                        <h2 className="text-2xl font-bold text-neutral-900 mb-4">6. Veri Güvenliği</h2>
                        <p className="text-neutral-600">
                    ...
                    <section>
                        <h2 className="text-2xl font-bold text-neutral-900 mb-4">7. KVKK Kapsamındaki Haklarınız</h2>
                        <p className="text-neutral-600 mb-4">
                    ...
                    <section>
                        ...
                        <div className="bg-slate-800 p-6 rounded-lg mt-4">
                            ...
                            <p className="text-neutral-900 mt-2"><strong>Adres:</strong> Kocaeli, Türkiye</p>
                        </div>
                    </section>

                    <section>
                        <h2 className="text-2xl font-bold text-neutral-900 mb-4">9. Değişiklikler</h2>
                        <p className="text-neutral-600">
