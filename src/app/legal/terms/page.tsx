        ...
        <PublicLayout>
            <div className="container mx-auto px-4 py-16 max-w-4xl">
                ...
                <div className="prose prose prose-neutral prose-lg max-w-none space-y-8">
                    <section>
                        <h2 className="text-2xl font-bold text-neutral-900 mb-4">1. Genel Hükümler</h2>
                    ...
                    <section>
                        <h2 className="text-2xl font-bold text-neutral-900 mb-4">2. Hizmet Tanımı</h2>
                        <p className="text-neutral-600">
                    ...
                    <section>
                        <h2 className="text-2xl font-bold text-neutral-900 mb-4">3. Üyelik ve Hesap</h2>
                    ...
                    <section>
                        <h2 className="text-2xl font-bold text-neutral-900 mb-4">5. Reklam İçeriği</h2>
                        <p className="text-neutral-600 mb-4">Yayınlanacak reklam içerikleri aşağıdaki kurallara uygun olmalıdır:</p>
                        <ul className="list-disc list-inside text-neutral-600 space-y-2">
                    ...
                    <section>
                        <h2 className="text-2xl font-bold text-neutral-900 mb-4">6. Kullanıcı Yükümlülükleri</h2>
                        <ul className="list-disc list-inside text-neutral-600 space-y-2">
                    ...
                    <section>
                        <h2 className="text-2xl font-bold text-neutral-900 mb-4">7. Sorumluluk Sınırları</h2>
                        <p className="text-neutral-600">
                    ...
                    <section>
                        <h2 className="text-2xl font-bold text-neutral-900 mb-4">8. Fikri Mülkiyet</h2>
                        <p className="text-neutral-600">
                    ...
                    <section>
                        <h2 className="text-2xl font-bold text-neutral-900 mb-4">9. Sözleşme Değişiklikleri</h2>
                        <p className="text-neutral-600">
