        ...
        <PublicLayout>
            <div className="container mx-auto px-4 py-16 max-w-4xl">
                    ...
                    <div className="bg-slate-800/50 p-8 rounded-2xl border border-slate-700">
                        <div className="flex items-center gap-4 mb-4">
                            ...
                            <div>
                                ...
                                <p className="text-neutral-500">7/24 yanıt</p>
                            </div>
                        </div>
                    ...
                    <div className="bg-slate-800/50 p-8 rounded-2xl border border-slate-700">
                        <div className="flex items-center gap-4 mb-4">
                            ...
                            <div>
                                ...
                                <p className="text-neutral-500">Hafta içi 09:00 - 18:00</p>
                            </div>
                        </div>
                    ...
                    <div className="bg-slate-800/50 p-8 rounded-2xl border border-slate-700">
                        <div className="flex items-center gap-4 mb-4">
                            ...
                            <div>
                                ...
                                <p className="text-neutral-500">Merkez ofis</p>
                            </div>
                        </div>
                    ...
                    <div className="bg-slate-800/50 p-8 rounded-2xl border border-slate-700">
                        <div className="flex items-center gap-4 mb-4">
                            ...
                            <div>
                                ...
                                <p className="text-neutral-500">Müşteri hizmetleri</p>
                            </div>
                        </div>
                        <p className="text-neutral-600">
                ...
                <div className="mt-12 prose prose prose-neutral max-w-none">
                    <h2 className="text-2xl font-bold text-neutral-900 mb-4">Şirket Bilgileri</h2>
                    <div className="bg-slate-800 p-6 rounded-lg">
                        <p className="text-neutral-600 mb-2"><strong>Şirket Adı:</strong> Pufero Mobilya Ticaret Limited Şirketi</p>
                        <p className="text-neutral-600 mb-2"><strong>Vergi Dairesi:</strong> Körfez Vergi Dairesi</p>
                        <p className="text-neutral-600 mb-2"><strong>Vergi No:</strong> 7331202819</p>
                        <p className="text-neutral-600 mb-2"><strong>Adres:</strong> Esentepe Mah. İplik Sk. No: 23 İç Kapı No: 1 Körfez/Kocaeli</p>
                    </div>
                </div>
            </div>
        </PublicLayout>
