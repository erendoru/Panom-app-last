    ...
    return (
        <PublicLayout>
            <div className="container mx-auto px-4 py-16 max-w-4xl">
                ...
                <p className="text-neutral-500 mb-8">Son güncelleme: 12 Ocak 2026</p>

                <div className="prose prose prose-neutral prose-lg max-w-none space-y-8">
                    <section>
                        <h2 className="text-2xl font-bold text-neutral-900 mb-4">MADDE 1 - TARAFLAR</h2>
                        <div className="bg-slate-800 p-6 rounded-lg space-y-4">
                            <div>
                                <h3 className="text-lg font-bold text-neutral-900 mb-2">1.1 SATICI</h3>
                                <p className="text-neutral-600"><strong>Unvan:</strong> Pufero Mobilya Ticaret Limited Şirketi</p>
                                <p className="text-neutral-600"><strong>Adres:</strong> Esentepe Mah. İplik Sk. No: 23 İç Kapı No: 1 Körfez/Kocaeli</p>
                                <p className="text-neutral-600"><strong>Telefon:</strong> +90 (262) 123 45 67</p>
                                <p className="text-neutral-600"><strong>E-Posta:</strong> destek@panobu.com</p>
                                <p className="text-neutral-600"><strong>Vergi Dairesi:</strong> Körfez Vergi Dairesi</p>
                                <p className="text-neutral-600"><strong>Vergi No:</strong> 7331202819</p>
                            </div>
                            <div>
                                <h3 className="text-lg font-bold text-neutral-900 mb-2">1.2 ALICI</h3>
                    ...
                    <section>
                        <h2 className="text-2xl font-bold text-neutral-900 mb-4">MADDE 2 - KONU</h2>
                        <p className="text-neutral-600">
                    ...
                    <section>
                        <h2 className="text-2xl font-bold text-neutral-900 mb-4">MADDE 3 - HİZMET BİLGİLERİ</h2>
                        <p className="text-neutral-600 mb-4">Satın alınan hizmetin temel özellikleri:</p>
                    ...
                    <section>
                        <h2 className="text-2xl font-bold text-neutral-900 mb-4">MADDE 4 - ÖDEME VE TESLİMAT</h2>
                        <div className="space-y-4">
                            <div>
                                <h3 className="text-lg font-bold text-neutral-900 mb-2">4.1 Ödeme</h3>
                                <ul className="list-disc list-inside text-neutral-600 space-y-2">
                            ...
                            <div>
                                <h3 className="text-lg font-bold text-neutral-900 mb-2">4.2 Hizmet Teslimi</h3>
                                <ul className="list-disc list-inside text-neutral-600 space-y-2">
                    ...
                    <section>
                        <h2 className="text-2xl font-bold text-neutral-900 mb-4">MADDE 5 - CAYMA HAKKI</h2>
                    ...
                    <section>
                        <h2 className="text-2xl font-bold text-neutral-900 mb-4">MADDE 6 - GENEL HÜKÜMLER</h2>
                    ...
                    <section>
                        <h2 className="text-2xl font-bold text-neutral-900 mb-4">MADDE 7 - UYUŞMAZLIK ÇÖZÜMÜ</h2>
                        <p className="text-neutral-600 mb-4">
                    ...
                    <section>
                        <h2 className="text-2xl font-bold text-neutral-900 mb-4">MADDE 8 - YÜRÜRLÜK</h2>
                        <p className="text-neutral-600">
                    ...
                    <section>
                        <h2 className="text-2xl font-bold text-neutral-900 mb-4">İLETİŞİM</h2>
                        <div className="bg-slate-800 p-6 rounded-lg">
                            <p className="text-neutral-900"><strong>E-posta:</strong> destek@panobu.com</p>
                            <p className="text-neutral-900 mt-2"><strong>Telefon:</strong> +90 (262) 123 45 67</p>
                            <p className="text-neutral-900 mt-2"><strong>Adres:</strong> Esentepe Mah. İplik Sk. No: 23 İç Kapı No: 1 Körfez/Kocaeli</p>
                        </div>
                    </section>
                </div>
            </div>
