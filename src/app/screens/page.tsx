...
import { digitalScreensCopy } from "@/messages/digitalScreens";

export default function DigitalBillboardsPage() {
    const { locale } = useAppLocale();
    const s = digitalScreensCopy(locale);
            ...
            <div className="container mx-auto px-4 py-16 md:py-24 relative bg-white">
                ...
                <div className="text-center max-w-4xl mx-auto mb-16">
                    <div className="inline-flex items-center gap-2 bg-blue-50 border border-blue-200 rounded-full px-4 py-2 mb-8">
                        ...
                        <span className="text-sm font-medium text-blue-800">{s.badge}</span>
                    </div>

                    <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight text-neutral-900">
                        {s.h1a}
                        <br />
                        <span className="text-neutral-700">{s.h1b}</span>
                    </h1>

                    <p className="text-lg md:text-xl text-neutral-600 mb-8 max-w-2xl mx-auto leading-relaxed">
                        {s.leadBefore}
                        <strong className="text-neutral-900">{s.strong1}</strong>
                        {s.leadMid}
                        <strong className="text-neutral-900">{s.strong2}</strong>
                        {s.leadAfter}
                    </p>
                ...
                <div className="relative max-w-5xl mx-auto mb-16">
                    <div className="relative grid md:grid-cols-3 gap-6">
                        <div className="bg-neutral-50 border border-neutral-200 rounded-3xl p-6 hover:border-neutral-300 transition-all group shadow-sm">
                            ...
                            <h3 className="text-xl font-bold mb-3 text-neutral-900">{s.card1t}</h3>
                            <p className="text-neutral-600 text-sm leading-relaxed">{s.card1d}</p>
                        </div>
                        ...
                        <div className="bg-neutral-50 border border-neutral-200 rounded-3xl p-6 hover:border-neutral-300 transition-all group shadow-sm">
                            ...
                            <h3 className="text-xl font-bold mb-3 text-neutral-900">{s.card2t}</h3>
                            <p className="text-neutral-600 text-sm leading-relaxed">{s.card2d}</p>
                        </div>
                        ...
                        <div className="bg-neutral-50 border border-neutral-200 rounded-3xl p-6 hover:border-neutral-300 transition-all group shadow-sm">
                            ...
                            <h3 className="text-xl font-bold mb-3 text-neutral-900">{s.card3t}</h3>
                            <p className="text-neutral-600 text-sm leading-relaxed">{s.card3d}</p>
                        </div>
                    </div>
                </div>

                <div className="max-w-3xl mx-auto">
                    <h2 className="text-2xl md:text-3xl font-bold text-center mb-10 text-neutral-900">{s.midTitle}</h2>

                    <div className="space-y-4">
                        {s.bullets.map((feature, i) => (
                            <div
                                key={i}
                ...
                <div className="text-center mt-16 pt-16 border-t border-neutral-200">
                    <h3 className="text-xl md:text-2xl font-bold mb-4 text-neutral-900">{s.bottomTitle}</h3>
                    <p className="text-neutral-600 mb-6">{s.bottomLead}</p>
                    <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                        <Link href="/static-billboards">
                            <Button className="bg-neutral-900 hover:bg-neutral-800 text-white rounded-full px-8">{s.bottomClassic}</Button>
                        </Link>
