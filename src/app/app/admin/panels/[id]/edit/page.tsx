    ...
    const fetchPanel = async () => {
        try {
            ...
            setFormData({
                ...
                priceWeekly: data.priceWeekly ? String(data.priceWeekly) : '',
                priceDaily: data.priceDaily ? String(data.priceDaily) : '',
                priceMonthly: data.priceMonthly ? String(data.priceMonthly) : '',
                price3Month: data.price3Month ? String(data.price3Month) : '',
                price6Month: data.price6Month ? String(data.price6Month) : '',
                priceYearly: data.priceYearly ? String(data.priceYearly) : '',
                printingFee: data.printingFee ? String(data.printingFee) : '',
                    ...
                    <div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div className="md:col-span-2 rounded-lg border border-amber-200 bg-amber-50 p-3 text-xs text-amber-900">
                                ...
                                Haftalık fiyat zorunlu değildir — 3 / 6 / 12 aylık fiyat vererek
