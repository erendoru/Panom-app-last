...
import { User, Mail, Phone, Building2, Save, Loader2, LogOut, FileText } from "lucide-react";
            ...
            try {
                ...
                if (res.ok) {
                    ...
                    setProfile({
                        ...
                        email: user.email || "",
                        phone: data.phone || "",
                        companyName: data.screenOwnerProfile?.companyName || "",
                        taxId: data.screenOwnerProfile?.taxId || "",
                        address: data.screenOwnerProfile?.address || "",
                    });
                } else {
                    setProfile((prev) => ({
                        ...prev,
    ...
    return (
        <div>
            <div className="mb-8">
                ...
                <p className="text-slate-500 mt-1">Profil ve şirket bilgilerinizi yönetin.</p>
            </div>
            ...
            <div className="max-w-2xl space-y-6">
                ...
                <div className="bg-white rounded-xl border border-slate-200 p-6 space-y-5">
                    ...
                    <div className="space-y-4">
                        ...
                        <div>
                            <label className="flex items-center gap-2 text-sm font-medium text-slate-700 mb-1.5">
                                <FileText className="w-4 h-4" /> Vergi Numarası
                            </label>
                            <Input
                                value={profile.taxId}
                        ...
                        <div>
                            <label className="text-sm font-medium text-slate-700 mb-1.5 block">Adres</label>
                            <textarea
